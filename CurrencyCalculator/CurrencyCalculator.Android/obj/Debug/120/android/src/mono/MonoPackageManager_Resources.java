...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "CurrencyCalculator.Android.dll" comes first in this list. */
		"CurrencyCalculator.Android.dll",
		"CurrencyRateCalculator.dll",
		"FormsViewGroup.dll",
		"MvvmNano.Core.dll",
		"MvvmNano.Forms.dll",
		"MvvmNano.Ninject.dll",
		"MvvmNano.TinyIoC.dll",
		"Newtonsoft.Json.dll",
		"Ninject.dll",
		"NuGet.Common.dll",
